<script lang="ts">
  ...
  const configuredModels = $derived(models.filter((m) => configuredProviderNames.has(m.provider)));
  ...
  <div class="selector-header">
    <div class="title-row">
      ...
      <div class="title-actions">
        <button class="btn small icon-btn" onclick={() => onRefresh?.()} title="Refresh model list">
          <svg
            width="14"
            height="14"
            viewBox="0 0 24 24"
