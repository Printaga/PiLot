<script lang="ts">
  ...
  const icons: Record<string, string> = {
    ...
    prompts:
      "M12 2v4 M12 22v-4 M4.93 4.93l2.83 2.83 M16.24 16.24l2.83 2.83 M2 12h4 M18 12h4 M4.93 19.07l2.83-2.83 M16.24 7.76l2.83-2.83",
    packages:
      "M21 16.5c0 .552-.448 1-1 1H4c-.552 0-1-.448-1-1V8.5c0-.552.448-1 1-1h16c.552 0 1 .448 1 1v8zM21 8.5V6c0-.552-.448-1-1-1H4c-.552 0-1-.448-1-1v2.5M4 12h16",
  };
...
<style>
  ...
  @keyframes badge-pulse {
    0%,
    100% {
      box-shadow: 0 0 0 0 oklch(from var(--color-warning) l c h / 0);
    }
    50% {
      box-shadow: 0 0 0 4px oklch(from var(--color-warning) l c h / 0.15);
    }
  }
